...
import Slide, { TutorialSlide, WinSlide } from "../components/Slide";
    ...
    return (
        <div className="story">
            ...
            {slideNumber == 3 && (
                <Slide
                    src="/Panel4.webp"
                    dialogue="The MBS is well renowned for its efficiency and prestige, using live recordings for the most up-to-date information."
                    onSlideFinish={increaseSlide}
                />
            )}
            {slideNumber == 4 && (
...
export function StoryEnd({ onStoryEnd, won }: StoryEnd) {
    return (
        <div className="story">
            ...
            {!won && (
                <Slide
                    src="/BananaShortage.webp"
                    dialogue="Harvey failed to locate the cartel. The world undergoes a banana shortage."
                    onSlideFinish={onStoryEnd}
                />
            )}
        </div>
